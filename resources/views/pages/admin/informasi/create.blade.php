...
@section('title', 'Tambah Informasi - Admin PPID')
...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4 pb-6 border-b border-gray-200">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Tambah Data Informasi</h1>
                <p class="text-gray-500">Isi detail dokumen informasi publik yang ingin ditampilkan.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('admin.informasi.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">Ringkasan Informasi (Judul) <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="ringkasan_informasi" required
                        placeholder="Contoh: Laporan Keuangan Triwulan I"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-gray-700">Penanggung Jawab (Bidang/Seksi) <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="penanggung_jawab" required placeholder="Contoh: Sekretariat Dispora"
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-tosca-500 outline-none transition-all">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-gray-700">Format File Asli <span
                                class="text-red-500">*</span></label>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="deskripsi" rows="2" placeholder="Jelaskan isi singkat dari informasi ini..."
                ...
                <div class="space-y-2 p-5 bg-gray-50 border border-gray-200 rounded-xl border-dashed">
                    <label class="block text-sm font-semibold text-gray-700">Unggah File Dokumen (Opsional jika
                        Dikecualikan)</label>
                    <input type="file" name="file_dokumen" accept=".pdf,.xls,.xlsx,.doc,.docx"
                        class="w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-tosca-600 file:text-white hover:file:bg-tosca-700 cursor-pointer">
                    <p class="text-xs text-gray-500 mt-1">*Format: PDF, Excel, Word. Maksimal 10MB.</p>
                </div>
