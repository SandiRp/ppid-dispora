...
@section('title', 'Unggah Laporan Baru - Admin PPID')
...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4 pb-6 border-b border-gray-200">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Unggah Laporan Baru</h1>
                <p class="text-gray-500">Pilih kategori laporan agar masuk ke halaman yang tepat.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('admin.laporan.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="space-y-2">
                    <label class="block text-sm font-semibold text-gray-700">Judul Laporan <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="judul" required
                        placeholder="Contoh: Laporan Tahunan Layanan Informasi PPID"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-gray-700">Kategori Laporan <span
                                class="text-red-500">*</span></label>
                        <select name="kategori" required
                            ...
                            <option value="akses">Laporan Akses Informasi</option>
                            <option value="pelayanan">Laporan Pelayanan Publik</option>
                        </select>
                    </div>

                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-gray-700">Tahun Laporan <span
                                class="text-red-500">*</span></label>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="deskripsi" rows="2" placeholder="Catatan singkat mengenai isi laporan..."
                ...
                <div class="space-y-2 p-5 bg-gray-50 border border-gray-200 rounded-xl border-dashed">
                    <label class="block text-sm font-semibold text-gray-700">Unggah File Laporan (Wajib PDF) <span
                            class="text-red-500">*</span></label>
