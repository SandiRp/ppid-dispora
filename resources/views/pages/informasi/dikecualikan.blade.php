...
@section('title', 'Informasi yang Dikecualikan - PPID Dispora Jatim')
...
@section('content')
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="pb-6 border-b border-gray-200 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Informasi yang Dikecualikan</h1>
                <p class="text-gray-500">Informasi yang tidak dapat diakses oleh publik karena alasan ketat (rahasia negara,
                    persaingan usaha tidak sehat, hak pribadi, dll).</p>
            </div>
        </div>
                                ...
                                <td class="py-4 px-6 text-center">
                                    @if ($item->file_dokumen)
                                        <button type="button" disabled
                                            class="inline-block text-red-400 bg-red-50 border border-red-200 p-2 rounded-lg cursor-not-allowed opacity-80"
                                            title="Dokumen Rahasia / Terkunci">
