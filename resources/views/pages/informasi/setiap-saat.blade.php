...
@section('title', 'Informasi Setiap Saat - PPID Dispora Jatim')
...
@section('content')
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="pb-6 border-b border-gray-200 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Informasi Setiap Saat</h1>
                <p class="text-gray-500">Informasi yang harus disediakan oleh Badan Publik dan siap tersedia untuk bisa
                    langsung diberikan kepada pemohon.</p>
            </div>
        </div>
