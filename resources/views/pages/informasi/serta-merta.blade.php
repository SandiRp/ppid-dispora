...
@section('title', 'Serta Merta - PPID Dispora Jatim')
...
@section('content')
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="pb-6 border-b border-gray-200 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Serta Merta</h1>
                <p class="text-gray-500">Informasi yang dapat mengancam hajat hidup orang banyak dan ketertiban umum yang
                    harus diumumkan tanpa penundaan.</p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="relative w-full sm:w-96">
                ...
                <input type="text" placeholder="Cari informasi serta merta..."
